...
namespace ChessGame
{
    class ChessBoard
    {
        ...
        public ChessBoard()
        {
            ...
            //    row, col
            board[0, 0] = new ChessPieceCastle(this, EChessSide.WHITE, 0, 0);
            board[0, 1] = new ChessPieceBishop(this, EChessSide.WHITE, 0, 1);
            board[0, 2] = new ChessPieceRook(this, EChessSide.WHITE, 0, 2);
            board[0, 3] = new ChessPieceKing(this, EChessSide.WHITE, 0, 3);
            board[0, 4] = new ChessPieceQueen(this, EChessSide.WHITE, 0, 4);
            board[0, 5] = new ChessPieceRook(this, EChessSide.WHITE, 0, 5);
            board[0, 6] = new ChessPieceBishop(this, EChessSide.WHITE, 0, 6);
            board[0, 7] = new ChessPieceCastle(this, EChessSide.WHITE, 0, 7);
            ...
            board[7, 0] = new ChessPieceCastle(this, EChessSide.BLACK, 7, 0);
            board[7, 1] = new ChessPieceBishop(this, EChessSide.BLACK, 7, 1);
            board[7, 2] = new ChessPieceRook(this, EChessSide.BLACK, 7, 2);
            board[7, 3] = new ChessPieceKing(this, EChessSide.BLACK, 7, 3);
            board[7, 4] = new ChessPieceQueen(this, EChessSide.BLACK, 7, 4);
            board[7, 5] = new ChessPieceRook(this, EChessSide.BLACK, 7, 5);
            board[7, 6] = new ChessPieceBishop(this, EChessSide.BLACK, 7, 6);
            board[7, 7] = new ChessPieceCastle(this, EChessSide.BLACK, 7, 7);
